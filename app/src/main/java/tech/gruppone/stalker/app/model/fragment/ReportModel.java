              ...
              try {
                ...
                for (int i = 0; i < jsonOrganizationsHistory.length(); i++) {
                  ...
                  for (int j = 0; j < historyArray.length(); j++) {
                    ...
                    userOrganizationHistories.add(
                        new UserOrganizationHistory(timestamp, placeId, inside));
                  }
                  userOrganizationHistories.sort(
                      (e1, e2) ->
                          Long.valueOf(e2.getTimestamp())
                              .compareTo(Long.valueOf(e1.getTimestamp())));
