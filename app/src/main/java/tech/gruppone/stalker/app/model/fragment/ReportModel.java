            ...
            jsonObject -> {
              try {
                ...
                for (int i = 0; i < jsonOrganizationsHistory.length(); i++) {
                  ...
                  // getPlacesFromOrganizationid(organizationId);
                  ...
                  for (int j = 0; j < historyArray.length(); j++) {
                    String organizationName =
                        Objects.requireNonNull(organization.getValue()).getName();
                    ...
                    /*UserOrganizationHistory userOrganizationHistory =
                        new UserOrganizationHistory(
                            jsonUserOrganizationHistory, organizationName, placeNames);
                  ...
                  // updateLocalDb(userOrganizationHistories);
                }
